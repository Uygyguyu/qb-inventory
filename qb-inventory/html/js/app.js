    ...
    $.post(
        ...
        function(data) {
            ...
            $(".weapon-attachments-container-details").html(
                ...
                '<br><br><span style="font-weight: bold; letter-spacing: .1vh;">Dayanıklılık - ' +
                Durability.toFixed() +
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Isim: </strong><span>" +
                ...
                gender +
                "</span></p><p><strong>Milliyet: </strong><span>" +
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Isim: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Soyisim: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Doğum Tarihi: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Tür: </strong><span>" +
                itemData.info.type +
                "</span></p>"
            );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p>" + itemData.info.uses + " kullanır.</p>"
            );
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    "<p><strong>Kanıt Malzemesi: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Tip: </strong><span>" +
                    itemData.info.ammotype +
                    "</span></p><p><strong>Açıklama: </strong><span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><strong>Seri Numarası: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Olay Yeri: </strong><span>" +
                ...
                $(".item-info-description").html(
                    ...
                    "</span></p><p><strong>DNA: </strong><span>" +
            ...
            $(".item-info-description").html('<p><strong>Plate: </strong><span>'+ itemData.info.label + '</span></p>'
                ...
                $(".item-info-description").html(
                    "<p><strong>Kanıt Malzemesi: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Parmak İzi: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Kanıt Malzemesi: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>DNA Kodu: </strong><span>" +
                    itemData.info.dnalabel +
                    "</span></p><br /><p>" +
                    itemData.description +
                    "</p>"
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Nakit Miktarı: </strong><span>$" +
                itemData.info.cash +
                "</span></p>"
            );
            ...
            var cardNumber = "************" + res;
            $(".item-info-description").html('<p><strong>Kart Sahibi:  </strong><span>' + itemData.info.name + '</span></p><p><strong>Citizen ID: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Kart Numarası: </strong><span>' + cardNumber + '</span></p>');			
...
function updateweights($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    let playerWeightPercentage = (parseInt(totalWeight) / playerMaxWeight) * 100;
    $("#player-inv-weight-fill").css("width", playerWeightPercentage + "%");
    ...
    if (
        ...
        let otherWeightPercentage = (parseInt(totalWeightOther) / otherMaxWeight) * 100;
        $("#other-inv-weight-fill").css("width", otherWeightPercentage + "%");
    }
